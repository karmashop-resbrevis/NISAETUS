            ...
            <div className="flex items-center justify-between px-5 sm:px-20 py-3 border-b border-black/20">
                ...
                <div className="flex items-center gap-5">
                    <div className="text-sm gap-4">
                        <Menu className="icon w-6 h-6" onClick={() => setMenuSidebar(!menuSidebar)}/>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className={'relative'}>
                        <ShoppingBag className={'icon'} onClick={() => setBagSidebar(!bagSidebar)}/>
                    </div>
                    <User2 className={'icon'} onClick={() => setUserSidebar(!userSidebar)}/>
                </div>
            </div>
