...
const HomeContents = () => {
  ...
  return (
    <div className='pb-10 overflow-hidden'>
      ...
      <div className="container mx-auto px-5 py-10 sm:py-20 flex flex-col gap-10">
        <AnimatePresence>
          {hotProducts.map((product, index) => (
            <div
              key={product._id}
              className={`flex items-center mb-20 sm:mb-32 ${
                index % 2 === 0 ? 'flex-col gap-5 sm:gap-16 sm:flex-row' : 'flex-col gap-5 sm:gap-16 sm:flex-row-reverse'
              }`}
            >
              <motion.div
                initial='hidden'
      ...
      <motion.div 
        ...
        viewport={{once: true}}
        className='container mx-auto max-w-7x px-5 mb-10 text-lg sm:text-2xl font-bold'
      >
        <h1>{NisaetusText.newproductstext}</h1>
      </motion.div>

      <div className='container grid grid-cols1 sm:grid-cols-2 gap-1 mx-auto max-w-7x px-5 mb-20'>
